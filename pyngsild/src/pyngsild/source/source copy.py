...
from typing import Any, Callable, List, Protocol, Sequence, Tuple, TypeVar
...
class Source(Iterable):
    ...
    def from_fileOLD(
        ...
        **kwargs
        ...
        ext = Path(filename).suffixes[-1][1:]  # last extension w/o dot
        if ext in cls.registered_extensions:
            klass, binary, kwargs = cls.registered_extensions[ext]
            return klass(filename, **kwargs)
